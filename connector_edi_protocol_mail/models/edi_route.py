...
class EdiEnvelopeRoute(models.Model):
    ...
    protocol = fields.Selection(selection_add=[("mail", "Email")])

    def get_alias_model_name(self, vals):
        return vals.get("alias_model", "edi.envelope.route")

    def get_alias_values(self):
        values = super(EdiEnvelopeRoute, self).get_alias_values()
        values["alias_defaults"] = {"edi_route_id": self.id}
        return values
    ...
    def action_mail_demo(self):
        self.env["mail.message"].sudo().search([("subject", "=", "OFO CSV")]).unlink()
...
Received: from smtp.equip4work.co.uk (unknown [91.192.195.243])	by
 inbound1.ore.mailhop.org (Halon) with ESMTP	id
 52b28df3-7b57-11e7-93cc-bb360a9caeff;	Mon, 07 Aug 2017 10:01:04 +0000 (UTC)
Received: from mail pickup service by smtp.equip4work.co.uk with Microsoft
 SMTPSVC;	 Mon, 7 Aug 2017 11:01:03 +0100
From: Sales <sales@equip4work.co.uk>
To: Queries <{alias}@system.tcgroupuk.com>
Subject: OFO CSV
Thread-Topic: OFO CSV
Thread-Index: AdMPZBRAbjFx6xIhRK+4Safyg/4FfA==
Date: Mon, 7 Aug 2017 10:01:03 +0000
Message-ID: <F361624CE56D4D54B331F0FE8332DA09@netstudio.co.uk>
...
Content-ID: <B0B45B51E78F744F989EFDFC873B4575@equip4work.co.uk>
...
Content-ID: <9D0373C3D914764B9B9B3BF0817BCC90@equip4work.co.uk>
