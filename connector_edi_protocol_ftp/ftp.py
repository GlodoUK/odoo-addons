...
class Client:
    ...
    def __init__(
        ...
        max_retries: int = 5,
        use_ssl: typing.Union[None, bool] = None,  # noqa: UP007
    ):
        parsed = urlparse(url)
    ...
    def mlsd(self, remote_dir: typing.Union[None, str] = None):  # noqa: UP007
        ...
        self.client.setopt(pycurl.CUSTOMREQUEST, f"MLSD {remote_dir}")
    ...
    def list(self, remote_dir: typing.Union[None, str] = None):  # noqa: UP007
        """
    ...
    def delete(self, remote_filename: str):
        """Delete remote file."""
        self._raw(f"DELE {remote_filename}")

    def mkd(self, remote_dir: str):
        """Create remote directory."""
        self._raw(f"MKD {remote_dir}")

    def rmd(self, remote_dir: str):
        """Remove remote directory."""
        self._raw(f"RMD {remote_dir}")

    def rename(self, from_remote_file: str, to_remote_file: str):
        """Rename remote file."""
        self._raw(f"RNFR {from_remote_file}")
        self._raw(f"RNTO {to_remote_file}")
