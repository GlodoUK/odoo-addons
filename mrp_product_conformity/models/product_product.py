...
class ProductProduct(models.Model):
    ...
    _conformity_start_date_required = models.Constraint(
    ...
    def action_unarchive(self):
        ...
        self.conformity_start_date = fields.Datetime.now()
        return res
    ...
    def _cron_conformity(self):
        ...
        conformity_group_id = self.env.ref(
            "product_conformity.group_conformity_alert",
        ...
        for product in conformity_product_ids:
            ...
            if conformity_group_id:
                alert_id.message_post(
                    body=self.env._(
                        "Conformity period expired for %s.", product.display_name
                    ),
